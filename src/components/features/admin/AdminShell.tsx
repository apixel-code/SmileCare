          ...
          <div className="sticky top-0 z-40 flex h-[76px] items-center justify-between gap-4 border-b border-white/70 bg-white/88 px-5 shadow-[0_10px_30px_rgba(26,43,60,0.06)] backdrop-blur-xl md:px-7">
            ...
            <div className="flex items-center gap-2.5">
              <button
                ...
                className="flex min-h-[50px] items-center gap-2 rounded-2xl bg-cta px-4 font-heading text-[15px] font-bold text-white shadow-[0_10px_24px_rgba(255,122,89,0.32)] transition-colors hover:bg-cta-dark md:px-6"
              >
